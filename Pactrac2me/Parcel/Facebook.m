...
- (BOOL)isSessionValid {
    ...
    NSString *stringDate=[formatter stringFromDate:self.expirationDate];
    
  
    
    return (self.accessToken != nil && self.expirationDate != nil && self.expirationDate && stringDate != nil
