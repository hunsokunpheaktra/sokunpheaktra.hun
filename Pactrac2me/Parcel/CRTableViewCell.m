...
- (void)setIsSelected:(BOOL)isSelected
{
    ...
    imageView = [UIImageView new];
    self.imageView.image = (isSelected) ? _renderedMark : [UIImage imageNamed:@""];
    [self.contentView addSubview:imageView];
    [imageView release];
...
- (UIImage *)renderMark
{
    ...
    UIImage *selectedMark = [UIGraphicsGetImageFromCurrentImageContext() retain];
