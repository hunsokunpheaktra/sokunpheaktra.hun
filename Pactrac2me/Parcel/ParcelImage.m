...
#import "ParcelImage.h"
#import "DatabaseManager.h"

@implementation ParcelImage
...
+ (void)update:(Item *)item modifiedLocally:(BOOL)modifiedLocally {
    NSMutableDictionary *tmp = [[NSMutableDictionary alloc] initWithDictionary:item.fields];
    Item *itmp =[ParcelImage find:item.entity column:@"Id" value:[item.fields valueForKey:@"Id"]];
...
+ (void)initTable{
    ...
    [database check:@"ParcelImage" columns:columns types:types];
    [database createIndex:@"ParcelImage" column:@"local_id" unique:true];
