...
@interface SynchronizeViewController : UIViewController<UITableViewDelegate, UITableViewDataSource,SyncInterface,UIAlertViewDelegate,UIActionSheetDelegate> {
...
@property(nonatomic , retain) UIBarButtonItem *btnAction;
