...
- (id)initWithDictionaryRepresentation:(NSDictionary *)dictionary {
	...
	if (self != nil) {
		...
		NSArray *stepDics = [dictionaryRepresentation objectForKey:@"Steps"];
		...
		NSDictionary *endLocationDic = [dictionaryRepresentation objectForKey:@"End"];
		...
		summaryHtml = [dictionaryRepresentation objectForKey:@"summaryHtml"];
		polylineEndIndex = [[dictionaryRepresentation objectForKey:@"polylineEndIndex"] integerValue];
	}
	return self;
}
