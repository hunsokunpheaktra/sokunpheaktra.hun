...
@interface FeedsViewController : UITableViewController <RefreshInterface, SyncListener, UITextFieldDelegate, FeedListener , UIActionSheetDelegate, EGORefreshTableHeaderDelegate, LoadMoreFooterDelegate, TimeScrollerDelegate>  {
    ...
    //loading footer
    LoadMoreFooterView *_loadMoreFooter;
