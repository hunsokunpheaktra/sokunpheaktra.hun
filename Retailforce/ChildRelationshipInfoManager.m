...
+ (void)initTable {
    ...
    [database createIndex:CHILDRELATIONSHIPINFO_ENTITY column:@"entity" unique:false];
    [database createIndex:CHILDRELATIONSHIPINFO_ENTITY columns:[NSArray arrayWithObjects:@"entity",@"field", nil] unique:false];
}
