...
- (void)describeSObjectResult:(id)result error:(NSError *)error context:(id)context{
    ...
    if (result != nil && error == nil)
    {
        ...
        NSMutableArray *allColumns = [[[NSMutableArray alloc] initWithCapacity:1] autorelease];
        NSMutableArray *allTypes = [[[NSMutableArray alloc] initWithCapacity:1] autorelease];
        //FieldInfo
