...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"RetailForce launchOptions = %@", url);
    }    
...
// only valid if RetailForce-Info.plist specifies a protocol to handle
